...
public class Grammaire1Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "VAR_GLOBAL", "TYPE", "IFSTATEMENT", 
			"ELSEFSTATEMENT", "FORSTATMENT", "OPRATEUR_LOGIQUE", "OPRATEUR_ARETHMETIC1", 
			"OPRATEUR_ARETHMETIC2", "OPRATEUR_COMPARAISON", "INT", "FLOAT", "CHAR", 
			"MOTS", "ID", "PVG", "WS"
		};
	}
	...
	public Grammaire1Lexer(CharStream input) {
		super(input);
